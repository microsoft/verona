...
namespace path
{
  ...
  // absolute paths (returned by path::executable() and path::canonical()) have
  // a drive letter prefix, but still use / as the delimiter. Directories always
  ...
  // Returns the filename portion of the path, if any, otherwise the last
  // element of the directory portion of the path, if any.
