...
file(GLOB TEST_FOLDERS CONFIGURE_DEPENDS  ${CMAKE_CURRENT_LIST_DIR}/*)
foreach(TEST_FOLDER ${TEST_FOLDERS})
  ...
  if(${TEST_FOLDER} MATCHES ".*/parse")
    file(GLOB PARSE_TESTS CONFIGURE_DEPENDS "${TEST_FOLDER}/ast-parse/*.verona")
    ...
    file(GLOB PARSE_TESTS CONFIGURE_DEPENDS "${TEST_FOLDER}/parser/*.verona")
    foreach(PARSE_TEST ${PARSE_TESTS})
      get_filename_component(TEST_NAME ${PARSE_TEST} NAME_WE)
  ...
  elseif(${TEST_FOLDER} MATCHES ".*/mlir")
    file(GLOB MLIR_TESTS CONFIGURE_DEPENDS "${TEST_FOLDER}/mlir-parse/*.verona" "${TEST_FOLDER}/mlir-parse/*.mlir")
